...
CREATE TABLE IF NOT EXISTS `resu_location_speciality_menu` (
  `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `resu_location_id` INT(10) UNSIGNED NOT NULL,
  `resu_specialty_menu_option_id` INT(11) UNSIGNED NOT NULL,
  `created_at` INT(11) NULL DEFAULT NULL,
  `created_by` INT(11) NOT NULL,
  `updated_at` INT(11) NULL DEFAULT NULL,
  `updated_by` INT(11) NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_resu_location_speciality_menu_resu_specialty_menu_option1`
    FOREIGN KEY (`resu_specialty_menu_option_id`)
...
SHOW WARNINGS;
CREATE INDEX `fk_resu_location_speciality_menu_resu_specialty_menu_option_idx` ON `resu_location_speciality_menu` (`resu_specialty_menu_option_id` ASC);

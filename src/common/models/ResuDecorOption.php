...
class ResuDecorOption extends \resutoran\common\models\ResuBase
{
    ...
    /**
     * @inheritdoc
     * @return \resutoran\common\models\query\ResuDecorOptionQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \resutoran\common\models\query\ResuDecorOptionQuery(get_called_class());
    }
}
